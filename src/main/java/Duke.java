...
//    }
//
//    private static String formatAdd(ArrayList<Task> list, Task task) {
...
//                    list.add(todo);
//                    System.out.println(formatAdd(list, todo));
//                } catch (Exception e) {
...
//                    list.add(deadline);
//                    System.out.println(formatAdd(list, deadline));
//                } catch (Exception e) {
...
//                    list.add(event);
//                    System.out.println(formatAdd(list, event));
//                } catch (Exception e) {
